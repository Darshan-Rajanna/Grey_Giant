...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden selection:bg-primary/30 flex items-center pt-20">
      ...
      <div className="container mx-auto px-6 py-12 relative z-10 flex flex-col items-center justify-center">
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 w-full max-w-7xl items-start">
          ...
          <div className="lg:col-span-12 xl:col-span-5 h-full">
            ...
            >
              <div className="space-y-4 mb-10 text-center xl:text-left">
                <motion.div
