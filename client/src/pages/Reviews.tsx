...
const ReviewCard = ({ testimonial, onClick }: any) => {
  return (
    <motion.div
      ...
      className="group/card relative p-6 bg-white/[0.03] border border-white/10 rounded-[2rem] overflow-hidden flex flex-col transition-all duration-500 w-[320px] md:w-[380px] shrink-0 cursor-pointer"
    >
      ...
      <div className="flex-grow flex flex-col justify-center text-left">
        <blockquote className="text-[13px] text-white/70 italic leading-relaxed font-serif line-clamp-3">
          "{testimonial.comment}"
        </blockquote>
      </div>
