            ...
            <div className="flex items-center gap-5 group cursor-pointer">
              <div className="relative">
                 ...
                 <img 
                    src={logoImg} 
                    alt="Grey Giant Logo" 
                    className="relative w-14 h-14 object-contain rounded-2xl border border-white/10 transition-transform duration-700 group-hover:scale-110 group-hover:border-primary/30 shadow-2xl" 
                 />
              </div>
              <div className="flex flex-col items-start leading-none group-hover:translate-x-1 transition-transform duration-700">
                 <h2 className="text-3xl font-serif italic tracking-tighter">
                   <span className="text-white group-hover:text-primary transition-colors duration-700">Grey</span> <span className="text-primary group-hover:text-white transition-colors duration-700">Giant</span>
                 </h2>
              </div>
            </div>
